...
//		Bat bat4 = new Bat("Brandon",c,666);
...
//		batDao.addBats(batList);
		...
		List<Bear> result = bearDao.getGBears();
		for (Bear b : result) {
			System.out.println(b.toString());
		}

		List<Bat> res = batDao.getWingspanBat();
		for (Bat bat : res) {
			System.out.println(bat.toString());
		}
		
		System.out.println(batDao.getTotalWingspan());
		System.out.println(bearDao.getNumBears());
	}
}
